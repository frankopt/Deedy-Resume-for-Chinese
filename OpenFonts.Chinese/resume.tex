...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{史}{文哲}{ \urlstyle{same}\href{mailto:nwpufrank@gmail.com}{nwpufrank@gmail.com} | 176 1043 6835
}
...
\section{项目与论文}
\sectionsep
\runsubsection{ACFS Stress and Destructive Test}
\descript{Owner}
...
\runsubsection{ASM/IOS project testing}
\descript{Teamworker}
...
\runsubsection{RAC Installation/CVU}
\descript{Owner}
